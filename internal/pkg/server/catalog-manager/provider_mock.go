...
// Source: github.com/napptive/catalog-manager/internal/pkg/provider (interfaces: MetadataProvider)
...
func (m *MockMetadataProvider) Add(arg0 *entities.ApplicationMetadata) (*entities.ApplicationMetadata, error) {
	m.ctrl.T.Helper()
...
func (m *MockMetadataProvider) Get(arg0 entities.ApplicationID) (*entities.ApplicationMetadata, error) {
	m.ctrl.T.Helper()
