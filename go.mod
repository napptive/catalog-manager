...
require (
	...
	github.com/napptive/grpc-catalog-go v0.21.0
	github.com/napptive/grpc-playground-apps-go v0.24.0
	...
	github.com/napptive/oam-utils v0.0.0-20220905133226-c48c4a72cb6d
